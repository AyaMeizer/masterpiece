                        ...
                        <div class="card">
                            ...
                            <form method="post" action="{{url('updateUser/'.$user->id
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nf-email" value="{{$user->name}}" name="name"  placeholder="Enter username.." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-email" class=" form-control-label">Email</label>
                                        <input type="email" id="nf-email" value="{{$user->email}}" name="email"  placeholder="Enter Email.." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-password" class=" form-control-label">Password</label>
                                        <input type="password" id="nf-password" value="{{$user->password}}" name="password" placeholder="Enter Password.." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-password" class=" form-control-label">Phone</label>
                                        <input type="number" id="nf-password" value="{{$user->phone}}" name="phone" placeholder="Enter Your Phone.." class="form-control" required>
                                    </div>
                                    <div class="form-group">
